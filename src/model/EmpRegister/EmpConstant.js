...
export const codeHelperData_abbNation = {
  ...
  headers: [
    ...
    { field: "abbNation_display", text: "거주지국명" },
  ],
  tableData: [
...
export const codeHelperData_cdNation = {
  ...
  headers: [
    ...
    { field: "cdNation_display", text: "국적명" },
  ],
  tableData: [
...
export const codeHelperData_cdDept = {
  ...
  headers: [
    ...
    { field: "cdDept_display", text: "부서이름" },
  ],
  tableData: [
...
export const codeHelperData_cdOccup = {
  ...
  headers: [
    ...
    { field: "cdOccup_display", text: "직종명" },
  ],
  tableData: [
...
export const codeHelperData_rankNo = {
  ...
  tableData: [
    ...
    { item: { rankNo: "RK11", rankNo_display: "연구원" } },
...
export const codeHelperData_cdSalcls = {
  ...
  headers: [
    ...
    { field: "cdSalcls_display", text: "호봉" },
  ],
  tableData: [
...
export const codeHelperData_cdProject = {
  ...
  headers: [
    ...
    { field: "cdProject_display", text: "프로젝트명" },
  ],
  tableData: [
