    ...
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden" }}>
      ...
      >
        ...
        <div
          ...
          className="justify-content-center SUITE"
        >
          {/* 회원가입 제목 */}
          <div id="signup-container-title" className="Cabin p-24">
            SIGN UP
          </div>
              ...
              <Col md="7">
                ...
                <Col style={{ display: "flex", alignItems: "center" }}>
                  ...
                  <label className="color-option">
                    ...
                    />
                    <span
                      style={{ backgroundColor: "rgb(18, 204, 108)" }}
                    ></span>
                  </label>
                  ...
                  <label className="color-option">
                    ...
                    />
                    <span
                      style={{ backgroundColor: "rgb(255, 134, 48)" }}
                    ></span>
                  </label>
                  <label className="color-option">
                    <input
                    ...
                    />
                    <span
                      style={{ backgroundColor: "rgb(255, 82, 82)" }}
                    ></span>
                  </label>
                  <label className="color-option">
                    <input
                    ...
                    />
                    <span
                      style={{ backgroundColor: "rgb(126, 58, 243)" }}
                    ></span>
                  </label>
                </Col>
              </Col>
